<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="algoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="算法详情" align="center" prop="algoContent" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:algo:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:algo:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listAlgo, getAlgo, delAlgo, addAlgo, updateAlgo } from "@/api/system/algo";
...
function handleExport() {
  proxy.download('system/algo/export', {
    ...queryParams.value
