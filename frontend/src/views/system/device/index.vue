<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="仪器简介" prop="deviceDesc">
        <el-input
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="仪器图片地址" align="center" prop="deviceImg" />
      <el-table-column label="仪器简介" align="center" prop="deviceDesc" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      ...
      <el-form-item v-if="renderField(true, true)" label="仪器图片地址" prop="deviceImg">
        <el-input v-model="form.deviceImg" placeholder="请输入仪器图片地址" />
      </el-form-item>
      <el-form-item v-if="renderField(true, true)" label="仪器简介" prop="deviceDesc">
        <el-input v-model="form.deviceDesc" placeholder="请输入仪器简介" />
      </el-form-item>
