...
class DeviceModel(BaseModel):
    ...
    device_model: Optional[str] = Field(default=None, description='仪器型号')
    device_remark: Optional[str] = Field(default=None, description='功能简介')
    device_room: Optional[str] = Field(default=None, description='存放位置')
